  ...
  return (
    <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-5 p-5 xl:p-0'>
      {blogs?.map((blog, index) => {
        return (
          <Link href={"/blog/" + blog.id} key={index} className='w-full border rounded-md bg-graident-dark p-5 hover:ring-2 ring-blue-600 transition-all cursor-pointer space-y-5 first:lg:col-span-2 first:md:col-span-3'>
